...
if __name__ == '__main__':
    ...
    parser.add_argument('--unsp', '-u', type=str)
    ...
    counts = pickle_load('word2path_target_path_count.dump')
    ...
    for layer_num in n_layers:
        for d_r in dropout_rate:
            ...
            while c_val <= 7:
                ...
                current_val_score = lexnet_w2p.evaluate(val_w1s, val_w2s, val_paths, val_labels)
                ...
                if current_val_score > max_val_score:
                    ...
                    serializers.save_npz(args.out + '/best.lex_net', lexnet_w2p)
                    test_score = lexnet_w2p.evaluate(test_w1s, test_w2s, test_paths, test_labels)
